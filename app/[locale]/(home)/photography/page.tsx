...
export async function generateMetadata({ params } : { params: Promise<{ locale: string }>}): Promise<Metadata> {
    ...
    return {
        title: t("title.photography"),
        description: t("description.photography"),
        openGraph: {
            title: t("title.photography"),
            description: t("description.photography"),
            locale: locale,
...
export default function page() {
    return (
        <div className='flex-center-col'>
            <DevelopmentCard
                icon={Settings}
                title='Photography gallery in development...'
                description='Photography posts feature for the portfolio is currently an on-development feature.'
            />
